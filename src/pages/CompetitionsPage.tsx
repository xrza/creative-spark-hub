...
const CompetitionsPage = () => {
  ...
  const filtered = (competitions || []).filter((c: any) => {
    // Конкурс с category="all" отображается в любом фильтре аудитории
    if (category === "children" && c.category !== "children" && c.category !== "all") return false;
    if (category === "teachers" && c.category !== "teachers" && c.category !== "all") return false;
